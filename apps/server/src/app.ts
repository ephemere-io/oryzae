...
import { adminErrors } from './contexts/shared/presentation/routes/admin-errors.js';
import { adminTools } from './contexts/shared/presentation/routes/admin-tools.js';
...
const app = new Hono()
  ...
  .route('/api/v1/admin/errors', adminErrors)
  .route('/api/v1/admin/tools', adminTools)
