...
import { BackToStudy, STUDY_EXIT_RESERVE } from '@/features/shared/study/components/back-to-study';
    ...
    <ThemeProvider>
      <SidebarProvider>
        <UnreadProvider value={unread}>
          ...
          {/* PC は上端の中央から垂れるタブ。SP は上段の左端の戻る（SpTopBar）が担う。 */}
          {device === 'pc' && showBackToStudy && <BackToStudy />}
