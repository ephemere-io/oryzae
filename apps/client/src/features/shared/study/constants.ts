...
/**
 * 扉から入ってきた直後の**定置**（`docs/oryzae-study/70-entrance.md`）。
 *
 * 認証画面の扉をくぐると、書斎は「溶けて現れる」のではなく**カメラが入ってきて止まる**。
 * 白く飛ばしてから現れていた頃は「せっかく空間性を表現しているのにブツ切れ」と
 * 報告された（PR #624 のレビュー）。扉の側は歩き続け、ここが受け止めて静かに止まる。
 *
...
export const ARRIVAL = {
  durationMs: 760,
  /**
   * 水平の距離の倍率（1 より大きいと手前）。**大きく動かさない** — 派手に寄ると
   * 「入ってきた」ではなく「飛んできた」になる。止まったことが分かる程度でよい。
   */
  distanceScale: 1.1,
